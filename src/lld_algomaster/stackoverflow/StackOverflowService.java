...
import lld_algomaster.stackoverflow.entity.*;
...
import lld_algomaster.stackoverflow.observer.ReputationManager;
...
public class StackOverflowService {
    ...
    public Question postQuestion(String userId, String title, String body, Set<Tag> tags) {
        ...
        question.notifyObservers(
                new Event(EventType.QUESTION_CREATED, author, question )
        );
    ...
    public Answer postAnswer(String userId, String questionId, String body) {
        ...
        answer.notifyObservers(
                new Event(EventType.ANSWER_CREATED,author, answer )
        );
        return answer;
    }
