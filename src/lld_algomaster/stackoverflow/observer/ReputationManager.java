...
public class ReputationManager implements PostObserver {
    ...
    private static final int CREATE_QUESTION_REP = 15;
    private static final int CREATE_ANSWER_REP = 15;
    ...
    public void onPostEvent(Event event) {
        ...
        switch (event.getType()) {
            ...
            case QUESTION_CREATED:
                postAuthor.updateReputation(CREATE_QUESTION_REP);
                break;

            case ANSWER_CREATED:
                postAuthor.updateReputation(CREATE_ANSWER_REP);
                break;
