...
import lld.design_splitwise.group.Group;
import lld.design_splitwise.group.GroupController;
import lld.design_splitwise.user.User;
import lld.design_splitwise.user.UserController;
...
public class SplitWise {
    ...
    AppExpenseManager appExpenseManager;

    public SplitWise() {
        userController = new UserController();
        groupController = new GroupController();
        balanceSheetController = new BalanceSheetController();
        appExpenseManager = new AppExpenseManager();
    }
    ...
    public void demo() {
        ...
        // add expense directly in app.
        List<Split> splits3 = new ArrayList<>();
        Split splits3_1 = new Split(userController.getUser("U1001"), 700);
        Split splits3_2 = new Split(userController.getUser("U2001"), 500);
        splits3.add(splits3_1);
        splits3.add(splits3_2);
        appExpenseManager.createAppExpense("Exp1003", "Dinner", 1200, userController.getUser("U1001"), ExpenseSplitType.UNEQUAL, splits3);
