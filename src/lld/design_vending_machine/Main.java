...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            vendingState.clickOnInsertCoinButton();

            vendingState = vendingMachine.getVendingState();
            vendingState.insertCoin(Coin.NICKEL);
            vendingState.insertCoin(Coin.QUARTER);
            // vendingState.insertCoin(vendingMachine, Coin.NICKEL);

            System.out.println("|");
            System.out.println("clicking on ProductSelectionButton");
            System.out.println("|");
            vendingState.clickOnStartProductSelectionButton();

            vendingState = vendingMachine.getVendingState();
            vendingState.chooseProduct( 102);
